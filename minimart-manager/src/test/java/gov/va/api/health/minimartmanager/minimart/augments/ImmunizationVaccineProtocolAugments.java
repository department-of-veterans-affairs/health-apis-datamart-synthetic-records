...
public class ImmunizationVaccineProtocolAugments {
    ...
    private static Optional<DatamartImmunization.VaccinationProtocols> vp(String series, Integer seriesDoses) {
        return Optional.of(DatamartImmunization.VaccinationProtocols.builder().seriesDoses(seriesDoses).series(series).build());
    }
